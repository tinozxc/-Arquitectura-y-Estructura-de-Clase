...
//Constructor Chaining , Encadenamiento de constructores ,
//Los constructores sobrecargados suelen llamarse entre sí
public class Mouse {
    ...
    // Constructor con 3 parámetros (el que realmente hace el trabajo) , encadenamiento entre 3
